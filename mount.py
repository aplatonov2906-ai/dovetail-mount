...
DT_FACE  = 4.5    # высота лицевой (узкой) грани полоски, мм (по видео ≈4,5; ЗАМЕРИТЬ)
DT_DEPTH = 2.0    # выступ полоски над коробкой, мм (ЗАМЕРИТЬ)
...
PLATE_BASE  = 0.0   # основание под полоской (у этой реплики полоска прямо на коробке), мм
RECV_TOP    = 46.0  # от середины полоски до верха коробки (по видео с рулеткой ≈46), мм
...
SIDE_ZC  = 24.0   # центр боковой планки по Z, мм
