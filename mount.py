...
Система координат (как на оружии):
  ...
  Y — поперёк, 0 = ось ствола; модель строится в −Y и при экспорте зеркалится,
      чтобы кронштейн стоял на ЛЕВОЙ стороне коробки (+Y), где планка
...
# Коробка
RECV_HALF_W = 19.25 # половина ширины низа коробки, мм (штангенциркуль: 44 с планкой − 5,5; крышка уже, 36,5)
...
ARC_Z0   = RECV_TOP - 5.5   # где вертикальная стенка переходит в дугу, мм (ниже — дуга упрётся в край крышки)
...
if __name__ == "__main__":
    ...
    # зеркалим: планка на левой стороне коробки
    body, jaw, tbody, tjaw = (o.mirror("XZ") for o in (body, jaw, tbody, tjaw))
